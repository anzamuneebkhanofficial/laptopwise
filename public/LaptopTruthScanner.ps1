# LaptopTruth Hardware Scanner v3.0 - Deep Hardware Fingerprint Agent
# Run as Administrator for full SMART, SMBIOS, and battery data access
...
Write-Host ""
Write-Host ("[*] Uploading to " + $endpoint + " ...") -ForegroundColor Cyan

try {
    $response = Invoke-RestMethod -Uri $endpoint -Method Post -Body $postBody -ContentType "application/json" -TimeoutSec 30
    Write-Host ""
    Write-Host "================================================================" -ForegroundColor Green
